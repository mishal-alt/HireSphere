            ...
            <div className="w-80 lg:w-96 border-r border-slate-100 flex flex-col shrink-0 bg-slate-50/30">
                <div className="p-8 border-b border-slate-100">
                    <div className="flex items-center justify-between mb-8">
                        <h3 className="text-xl font-black text-slate-900 uppercase tracking-tighter italic">Messages</h3>
                        <button
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-2">
                    ...
                    {conversations.length === 0 && !isLoadingConversations && (
                        <div className="p-10 text-center opacity-30">
                            ...
                            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">No active messages</p>
                        </div>
                    )}
                ...
                {activeConversationId ? (
                    <>
                        ...
                        <div className="p-10 border-t border-slate-100 bg-white">
                            <div className="bg-slate-50 border border-slate-200 rounded-[2.5rem] p-4 focus-within:border-primary/30 focus-within:bg-white transition-all shadow-sm">
                                ...
                                />
                                <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100/50 px-2">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center space-y-8 bg-slate-50/20">
                        ...
                        <div className="text-center space-y-3">
                            <h3 className="text-xl font-black text-slate-900 uppercase tracking-tighter italic">Select a Conversation</h3>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
                        ...
                        >
                            <div className="p-12 border-b border-slate-100 flex items-center justify-between">
                                <h3 className="text-3xl font-black text-slate-900 uppercase tracking-tighter italic">New Message</h3>
