        ...
        <div className="space-y-10 pb-10 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-slate-200 pb-8">
                <div className="space-y-1.5">
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight">Recent Activity</h1>
                    <p className="text-sm font-medium text-slate-500">Stay updated with your latest interview schedules and candidate activities.</p>
                </div>
                {unreadCount > 0 && (
                    <button
                    ...
                    {notifications.length > 0 ? (
                        ...
                        <div className="py-32 flex flex-col items-center justify-center bg-white border border-slate-200 border-dashed rounded-[3rem] text-center space-y-6 group">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-slate-400 font-bold uppercase tracking-widest text-[10px]">No new updates at this time.</p>
                            </div>
            ...
            <div className="p-8 bg-slate-50 flex flex-col sm:flex-row items-center justify-between gap-6 text-[10px] font-bold text-slate-400 uppercase tracking-widest rounded-[2rem] border border-slate-100 shadow-inner">
                <div className="flex items-center gap-3">
                    <div className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-100 flex items-center gap-2 italic">
                        <CheckCircle2 className="size-3" />
                        System Active
                    </div>
                </div>
                <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2.5 group cursor-pointer hover:text-primary transition-colors">
