                ...
                <div className="max-w-7xl w-full px-6 pt-40 pb-24">
                    <div className="flex flex-col gap-24 lg:flex-row lg:items-center">
                        ...
                        <div className="flex flex-col gap-8 lg:w-1/2">
                            ...
                            <div className="flex flex-wrap gap-6 pt-4">
                                <Link href="/register" className="bg-slate-950 text-white font-bold h-16 px-10 rounded-2xl shadow-xl shadow-slate-950/20 transition-all hover:scale-105 flex items-center tracking-widest uppercase text-xs">Join our platform</Link>
                    ...
                    <div className="mt-48 grid grid-cols-1 lg:grid-cols-2 gap-24 py-24 border-y border-slate-100 items-center">
                         ...
                         <div className="grid grid-cols-2 gap-4">
                              <div className="h-64 bg-slate-50 rounded-[2.5rem] border border-slate-100 flex flex-col items-center justify-center gap-4 group hover:bg-slate-950 hover:text-white transition-all duration-500">
                                   <Globe className="size-10" />
                                   <span className="text-[11px] font-bold uppercase tracking-widest">Global Reach</span>
                              </div>
                              <div className="h-64 mt-12 bg-slate-50 rounded-[2.5rem] border border-slate-100 flex flex-col items-center justify-center gap-4 group hover:bg-slate-950 hover:text-white transition-all duration-500">
                        ...
                        <div className="relative w-full rounded-[4rem] bg-slate-950 px-12 py-32 overflow-hidden text-center shadow-2xl">
                            <div className="relative z-10 flex flex-col items-center gap-10 text-white">
                                ...
                                <div className="flex flex-wrap justify-center gap-6 pt-6">
                                    <Link href="/contact" className="bg-white text-slate-950 text-[12px] uppercase font-bold h-20 px-16 rounded-2xl shadow-xl hover:scale-105 transition-all flex items-center tracking-widest">View Openings</Link>
...
function ValueCard({ icon: Icon, title, description }: { icon: any; title: string; description: string }) {
    return (
        <div className="flex flex-col gap-8 rounded-[2.5rem] bg-slate-50 p-12 border border-slate-100 transition-all duration-500 hover:border-slate-950 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 group">
            <div className="size-16 rounded-2xl bg-white border border-slate-200 text-slate-400 flex items-center justify-center transition-all duration-500 group-hover:bg-slate-950 group-hover:text-white group-hover:border-slate-950 shadow-sm">
