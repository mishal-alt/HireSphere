                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 pb-20">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <Link href="/" className="flex items-center gap-3">
                            <div className="size-10 bg-slate-900 rounded-xl flex items-center justify-center shadow-lg shadow-slate-900/10 transition-transform hover:scale-105 overflow-hidden">
